...
!****************************************************************************
    ...
    do while( iBand <= eigenStates%numStates )
       ...
       Call MinVecInit( minVec, hMatrix%hSize )
       Call MinVecInit( oldVec, hMatrix%hSize )
       ...
       Call Diagonalize( hMatrix%hSize, h, eigenStates%numStates,eigenStates,& 
...
!***************************************************************************
  Subroutine Diagonalize( hSize, hMatrix, nEig, eigenStates, & 
...
!****************************************************************************
    ...
    integer, intent( in ) :: hSize, nEig, kPoint, ReportNo
...
!*****************************************************************************
    ...
    do while( iBand <= eigenStates%numStates )
       ...
       Call MinVecInit( minVec, hamArray%hSize )
       Call MinVecInit( oldVec, hamArray%hSize )
